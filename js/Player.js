...
class User {
    constructor(hull, accuracy, firePower, playerNameSuffix) {
        this.hull = hull;
        ...
        if (playerNameSuffix) {
            specificName = " " + playerNameSuffix;
        }
        this.playerName = this.constructor.name + specificName;
    }
...
//setting players with user properties
class Schwarz extends User {
    retreat() {
        print("USS Schwarz is going home");
    }
}

class Invaders extends User {
}

class Retaliation {

        constructor(hitsTaken, enemyNeutralized) {

        this.hitsTaken = hitsTaken;
        
        this.enemyNeutralized = enemyNeutralized;
    }
}
...
function userInput(questionText) {
    if (!renderType) {
...
let print = function () {
    ...
    if (renderType && renderType == 'HTML') {
        ...
        logger.innerHTML = logger.innerHTML + "<br>" + data;
    }
}
